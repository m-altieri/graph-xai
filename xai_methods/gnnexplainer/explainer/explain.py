...
from ..utils import io_utils as io_utils
from ..utils import train_utils as train_utils
from ..utils import graph_utils as graph_utils
...
class ExplainModule(nn.Module):
    ...
    def forward(
        ...
        if self.graph_mode:
            ...
            node_pred = ypred[int(self.graph_idx), node_idx, :]
    ...
    def loss(self, pred, pred_label, node_idx, epoch):
        ...
        loss = pred_loss + size_loss + feat_size_loss  # era quello di sotto
    ...
    def log_adj_grad(self, node_idx, pred_label, epoch, label=None):
        ...
        if log_adj and self.writer is not None:
